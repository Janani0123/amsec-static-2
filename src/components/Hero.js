import HEROIMG from'../components/assets/home.jpg';
...
export default function Hero() {
  const config ={
    ...
    social:{
    githup:"https://github.com/Janani0123/amsec-static-2",
    facebook:"https://www.facebook.com/profile.php?id=100089322897670&mibextid=ZbWKwL",
    instagram:"https://www.instagram.com/_janani_selvaraj_1606/profilecard/?igsh=MTRpZHluaDI0ZDNjOA==" ,
    } 
    ...
    return <section className='flex flex-col  md:flex-row px-5 py-32  bg-secondary justify-center ' id= 'hero'>
        <div className=' md:  w-1/2 flex flex-col'>
            <h1 className=' text-white text-4xl font hero-font '>Hi, I'am Janani<br/>
              <p className='text-2xl'>{config.subtitle}</p>
             </h1> 
       <div className='flex py-10'>
           <a href={config.social.github} className='pr-5 hover:text-white'><AiOutlineGithub size={60}/></a>
           <a href={config.social.facebook} className='pr-5 hover:text-white'>< AiOutlineWhatsApp size={60}/></a>
